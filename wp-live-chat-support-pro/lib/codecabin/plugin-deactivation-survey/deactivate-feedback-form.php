...
add_action('admin_enqueue_scripts', 'codecabin_wplc_pro_deactivation_survey2');
function codecabin_wplc_pro_deactivation_survey2() {
 ...
 */
add_filter('codecabin_deactivate_feedback_form_plugins', 'wplc_pro_codecabin_deactivate_feedback_form_plugins');
function wplc_pro_codecabin_deactivate_feedback_form_plugins($plugins) {
	return $plugins;
}
